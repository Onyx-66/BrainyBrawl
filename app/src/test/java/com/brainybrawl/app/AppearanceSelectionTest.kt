...
class AppearanceSelectionTest{
    @Test fun onlyBoundedPackagedSlotsCanBeSelected(){
        ...
        for(index in 13..20)assertEquals("assets/frames/frame_${index}.png",AppearanceSelection(1,index).framePath)
        for(index in listOf(-1,0,21,Int.MAX_VALUE)){
